...
extern void *mono_aot_module_SendEmail_iOS_info;
...
extern void *mono_aot_module_SendEmail_info;
...
{
	mono_aot_register_module (mono_aot_module_SendEmail_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_SendEmail_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "SendEmail.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
